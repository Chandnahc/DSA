...
You are given a 2D integer array `matrix` of size $n \times n$ representing the adjacency matrix of an undirected graph with `n` vertices labeled from `0` to `n - 1`.
...
![example_1](https://assets.leetcode.com/uploads/2026/03/14/g41f.png)
...
![example_2](https://assets.leetcode.com/uploads/2026/03/14/g42f.png)
